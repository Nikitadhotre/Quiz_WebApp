...
<body>
    ...
    <div class='content'>
<div id='up' style=" position: relative;top: 90px;">History of Quizes</div>
        <?php
session_start();
    ...
    while($row = $result->fetch_assoc()){
        ...
        echo "
            <div class='quizes' style=' border:2px solid black; position: relative;top: 110px;margin-bottom: 20px;display:flex; flex-direction:row;height:120px;'>
               <a href='history1.php?id=" . $tb_name . "' style='text-decoration:underline;color:black;padding-left:20px;text-decoration:none; ''> Title: ".$row1['title']."<br>  Time: ".$row1['time']."<br>  Date: ".$row1['date']."  </a> 
